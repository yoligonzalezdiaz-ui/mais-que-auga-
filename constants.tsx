...
export const CENTERS: Center[] = [
  {
    ...
    features: ['Sala Fitness de 1000m²', 'Box de Crossfit', 'Piscina Panorámica', 'Zona de Peso Libre', 'Cardio Technogym', 'Vestuarios Premium', 'Parking Gratuito'],
    gallery: [
  ...
  },
  {
    ...
    features: ['2 Piscinas Olímpicas', 'Circuito Spa Completo', 'Jacuzzi y Chorros', 'Sauna y Baño Turco', 'Salas de Actividades Dirigidas', 'Zona de Nutrición', 'Fisioterapia'],
    gallery: [
  ...
  },
  {
    ...
    features: ['8 Pistas de Pádel', 'Gimnasio Exterior', 'Pista de Atletismo', 'Ludoteca Infantil', 'Cafetería Saludable', 'Zona de Barbacoa', 'Área de Descanso'],
    gallery: [
...
export const FAQ_DATA: FAQItem[] = [
  ...
  {
    question: "¿El entrenamiento personal tiene un coste adicional?",
    answer: "Sí, el entrenamiento personal es un servicio exclusivo que se contrata aparte de la cuota mensual. Puedes reservar sesiones individuales con nuestros monitores expertos directamente desde la sección 'Personal Trainers'."
  }
];
...
export const INITIAL_CLASSES: ScheduledClass[] = [
  // Lunes
  { id: '1', hour: '8:00', day: 'Lunes', name: 'MOVILIDAD & CORE', instructor: 'Paula Méndez', room: 'Sala Multiusos', category: Category.BAJO_IMPACTO, capacity: 20, booked: 12 },
  { id: '7', hour: '9:30', day: 'Lunes', name: 'TONO GENERAL', instructor: 'Sergio Domínguez', room: 'Sala Fitness', category: Category.FUNCIONAL, capacity: 30, booked: 25 },
  { id: '25', hour: '17:00', day: 'Lunes', name: 'LATIN DANCE', instructor: 'Paula Méndez', room: 'Gimnasio', category: Category.COREOGRAFICAS, capacity: 35, booked: 30 },
  { id: '30', hour: '18:30', day: 'Lunes', name: 'BODY PUMP', instructor: 'Sergio Domínguez', room: 'Sala Fitness', category: Category.FUNCIONAL, capacity: 30, booked: 28 },
  { id: '40', hour: '20:00', day: 'Lunes', name: 'SPINNING PRO', instructor: 'Héctor Jiménez', room: 'Sala Ciclo', category: Category.ALTO_IMPACTO, capacity: 25, booked: 15 },

  // Martes
  { id: '2', hour: '8:00', day: 'Martes', name: 'PILATES SUAVE', instructor: 'Paula Méndez', room: 'Sala Multiusos', category: Category.BAJO_IMPACTO, capacity: 20, booked: 18 },
  { id: '26', hour: '17:00', day: 'Martes', name: 'SPINNING', instructor: 'Héctor Jiménez', room: 'Sala Cardio', category: Category.ALTO_IMPACTO, capacity: 20, booked: 20 },
  { id: '31', hour: '18:30', day: 'Martes', name: 'TRX & CORE', instructor: 'Héctor Jiménez', room: 'Box Funcional', category: Category.FUNCIONAL, capacity: 12, booked: 10 },
  { id: '41', hour: '20:00', day: 'Martes', name: 'ZUMBA FIT', instructor: 'Lucía Romero', room: 'Gimnasio', category: Category.COREOGRAFICAS, capacity: 40, booked: 38 },

  // Miércoles
  { id: '3', hour: '8:00', day: 'Miércoles', name: 'YOGA DESPERTAR', instructor: 'Lucía Romero', room: 'Sala Multiusos', category: Category.BAJO_IMPACTO, capacity: 15, booked: 5 },
  { id: '9', hour: '9:30', day: 'Miércoles', name: 'PILATES', instructor: 'Paula Méndez', room: 'Sala Multiusos', category: Category.BAJO_IMPACTO, capacity: 20, booked: 19 },
  { id: '32', hour: '17:00', day: 'Miércoles', name: 'AQUAGYM', instructor: 'Lucía Romero', room: 'Piscina', category: Category.PISCINA, capacity: 15, booked: 12 },
  { id: '42', hour: '18:30', day: 'Miércoles', name: 'CROSS TRAINING', instructor: 'Héctor Jiménez', room: 'Box Funcional', category: Category.FUNCIONAL, capacity: 15, booked: 14 },
  { id: '52', hour: '20:00', day: 'Miércoles', name: 'BODY COMBAT', instructor: 'Sergio Domínguez', room: 'Sala Fitness', category: Category.ALTO_IMPACTO, capacity: 30, booked: 25 },

  // Jueves
  { id: '4', hour: '8:00', day: 'Jueves', name: 'POSTURAL TRAINING', instructor: 'Sergio Domínguez', room: 'Sala Fitness', category: Category.FUNCIONAL, capacity: 25, booked: 22 },
  { id: '33', hour: '17:00', day: 'Jueves', name: 'STEP CHOREO', instructor: 'Paula Méndez', room: 'Gimnasio', category: Category.COREOGRAFICAS, capacity: 25, booked: 10 },
  { id: '43', hour: '18:30', day: 'Jueves', name: 'HIIT BOX', instructor: 'Héctor Jiménez', room: 'Box Funcional', category: Category.ALTO_IMPACTO, capacity: 12, booked: 12 },
  { id: '53', hour: '20:00', day: 'Jueves', name: 'YOGA FLOW', instructor: 'Lucía Romero', room: 'Sala Multiusos', category: Category.BAJO_IMPACTO, capacity: 20, booked: 18 },

  // Viernes
  { id: '5', hour: '8:00', day: 'Viernes', name: 'BODY STRETCH', instructor: 'Lucía Romero', room: 'Sala Multiusos', category: Category.BAJO_IMPACTO, capacity: 20, booked: 8 },
  { id: '34', hour: '17:00', day: 'Viernes', name: 'NATACIÓN ADULTOS', instructor: 'Lucía Romero', room: 'Piscina', category: Category.PISCINA, capacity: 10, booked: 9 },
  { id: '44', hour: '18:30', day: 'Viernes', name: 'GAP (Glúteos/Abdo/Pierna)', instructor: 'Paula Méndez', room: 'Gimnasio', category: Category.FUNCIONAL, capacity: 30, booked: 25 },
  { id: '54', hour: '20:00', day: 'Viernes', name: 'CIRCUITO FUERZA', instructor: 'Sergio Domínguez', room: 'Sala Fitness', category: Category.FUNCIONAL, capacity: 20, booked: 15 },

  // Sábado
  { id: '60', hour: '9:30', day: 'Sábado', name: 'MASTERCLASS SPINNING', instructor: 'Héctor Jiménez', room: 'Sala Ciclo', category: Category.ALTO_IMPACTO, capacity: 30, booked: 29 },
  { id: '61', hour: '11:00', day: 'Sábado', name: 'YOGA DINÁMICO', instructor: 'Lucía Romero', room: 'Sala Multiusos', category: Category.BAJO_IMPACTO, capacity: 20, booked: 12 },
  
  // Domingo
  { id: '70', hour: '10:00', day: 'Domingo', name: 'ENTRENO FAMILIAR', instructor: 'Sergio Domínguez', room: 'Gimnasio', category: Category.FUNCIONAL, capacity: 40, booked: 20 },
];
